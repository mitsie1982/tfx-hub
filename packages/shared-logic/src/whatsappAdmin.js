...
function createWhatsappAdminApi(client, context = {}) {
  ...
  return {
    async getSession(phoneNumber) {
      ...
      const response = await client.get(`/whatsapp/admin/session/${encodeURIComponent(phoneNumber)}`, withContext());
    ...
    async sendMessage(phoneNumber, message) {
      ...
      const response = await client.post('/whatsapp/admin/messages', { phoneNumber, message }, withContext());
      return response.data;
    }
  };
}

module.exports = { createWhatsappAdminApi };
