...
async function run() {
  ...
  try {
    ...
    assert.ok(contractorPayload.reply.includes('Welcome back, Theuns'));
    assert.ok(contractorPayload.reply.includes('Contractor snapshot'));
    assert.ok(contractorPayload.reply.includes('Completed jobs: 128'));
    assert.ok(contractorPayload.reply.includes('Response time: 8 min'));
    ...
    assert.ok(contractorLeadsPayload.reply.includes('Build garden wall') || contractorLeadsPayload.reply.includes('Boundary wall extension and gate footing'));
    ...
    assert.ok(!contractorFilteredLeadsPayload.reply.includes('Boundary wall extension and gate footing'));
    ...
    assert.ok(!contractorSearchResultsPayload.reply.includes('Boundary wall extension and gate footing'));
    ...
    assert.ok(contractorAllTradesPayload.reply.includes('Boundary wall extension and gate footing'));
    ...
    assert.ok(customerPayload.reply.includes('Welcome back, Michelle'));
